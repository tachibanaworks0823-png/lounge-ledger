...
const dailyBackKeys=['free1000','free1500','free2000','free2500','free3000','main1000','main1500','main2000','main2500','main3000','mainP','mainDecoration','mainChampagne','mainExtension','companion1000','companion1500','companion2000','companion2500','companion3000','companionP','companionDecoration','companionChampagne','companionExtension'];
function calcDailyInput(input){
  ...
  const bottlePercentBack=Number(input.mainBottle||0)*Number(data.settings.mainBottle||0)/100
    +Number(input.companionBottle||0)*Number(data.settings.companionBottle||0)/100;
